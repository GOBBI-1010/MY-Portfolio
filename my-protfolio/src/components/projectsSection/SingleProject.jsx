  ...
  return (
    ...
    >
      ...
      <div className="max-h-[220px] max-w-[400px] rounded-xl overflow-hidden hover:scale-110 transform transition-all duration-500 ralative border border-white">
        <div className="w-full h-full bg-black opacity-70 max-sm:bg-transparent absolute top-0 left-0 hover:opacity-0 transition-all duration-500 md:block sm:hidden"></div>
